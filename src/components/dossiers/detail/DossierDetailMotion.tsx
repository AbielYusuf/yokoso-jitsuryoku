...
export function DossierDetailMotion({ children }: { children: ReactNode }) {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      const back = root.querySelector<HTMLElement>("[data-dossier-detail-back]");
      const label = root.querySelector<HTMLElement>("[data-dossier-detail-label]");
      const title = root.querySelector<HTMLElement>("[data-dossier-detail-title]");
      const hero = root.querySelector<HTMLElement>("[data-dossier-detail-hero]");
      const blocks = gsap.utils.toArray<HTMLElement>("[data-dossier-detail]");
